...
int nxp_scale_serial_deinit(uint8_t port);
...
serial_hal_driver_t scale_serial_driver={
.init =nxp_scale_serial_init,
.deinit = nxp_scale_serial_deinit,
.enable_txe_int=nxp_scale_serial_enable_txe_int,
.disable_txe_int =nxp_scale_serial_disable_txe_int,
.enable_rxne_int =nxp_scale_serial_enable_rxne_int,
.disable_rxne_int =nxp_scale_serial_disable_rxne_int
};
